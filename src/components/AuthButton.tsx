...
function AuthButton() {
    ...
    if (user) {
        return (
            <div className="flex items-center gap-2 md:gap-3">
                ...
                <div className="hidden md:flex items-center gap-2.5 px-3 py-1.5 rounded-lg bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
                ...
                <div className="md:hidden relative" ref={menuRef}>
                    ...
                    >
                        <img
                            src={user.picture || 'https://api.dicebear.com/7.x/avataaars/svg?seed=User'}
                            alt={user.name || 'User'}
                            className="w-8 h-8 rounded-full border-2 border-blue-500 dark:border-blue-400 shadow-sm object-cover object-center ring-2 ring-blue-500/20 dark:ring-blue-400/20 cursor-pointer hover:ring-4 hover:ring-blue-500/30 dark:hover:ring-blue-400/30 transition-all"
                            style={{ objectPosition: 'center center' }}
                        />
                        <div className="absolute -bottom-0.5 -right-0.5 w-3 h-3 bg-green-500 border-2 border-white dark:border-gray-900 rounded-full"></div>
                    </motion.button>
                            ...
                            >
                                ...
                                <div className="py-1">
                                    <motion.button
                                        ...
                                        whileTap={{ scale: 0.98 }}
                                        className="w-full px-4 py-2.5 flex items-center gap-3 text-sm font-medium text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-950/20 transition-colors"
                                    >
                                        <LogOut size={16} />
                                        <span>Logout</span>
                                    </motion.button>
    ...
    return (
        <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="flex items-center justify-center gap-2 px-2 md:px-4 py-2 text-sm font-semibold text-white bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 rounded-lg transition-all shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50"
            title="Login"
        >
